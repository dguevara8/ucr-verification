...
class base_test extends uvm_test;
    ...
    virtual task run_phase(uvm_phase phase);
        riscv_stimulus stimulus_obj;

        super.run_phase(phase);

        phase.raise_objection(this);

        stimulus_obj = riscv_stimulus::type_id::create("stimulus_obj");
        stimulus_obj.start(env_obj.agent_obj.sequencer_obj);
...
endclass// Test principal del avance #2.
class base_test extends uvm_test;
